...
安装东西向网关
/root/istio-1.13.3/samples/multicluster/gen-eastwest-gateway.sh --mesh mesh1 --cluster cluster3 --network network2 | istioctl install -y  -f -
...
生成东西向网关
/root/istio-1.13.3/samples/multicluster/gen-eastwest-gateway.sh --mesh mesh1 --cluster cluster3 --network network3 | istioctl install -y -f -
...
创建访问apiserver secret
 ...
 scp remote-secret-cluster3.yaml root@192.168.229.148:/root
  传输secret到cluster2
 scp remote-secret-cluster3.yaml root@192.168.229.153:/root
...
生成东西向网关
/root/istio-1.13.3/samples/multicluster/gen-eastwest-gateway.sh --mesh mesh1 --cluster cluster2 --network network1 |  istioctl  install -y -f -
...
生成apiserver访问secret
 ...
 传输secret到cluster3
scp remote-secret-cluster1.yaml root@192.168.229.156:/root
...
生成apiserver访问secret
 ...
 scp remote-secret-cluster2.yaml root@192.168.229.148:/root
  ...
  传输secret到cluster3
 scp remote-secret-cluster2.yaml root@192.168.229.156:/root
